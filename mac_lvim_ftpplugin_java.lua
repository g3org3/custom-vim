...
local config = {
  ...
  root_dir = require("jdtls.setup").find_root { "mvnw", "pom.xml" },
    ...
    java = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-11",
            path = "~/.sdkman/candidates/java/11.0.14.1-jbr",
          },
          {
            name = "JavaSE-17",
...
function run_spring_boot(debug)
  vim.cmd("TermExec cmd='" .. get_spring_boot_runner(nil, debug) .. "'")
end
...
local mappings = {
  C = {
    ...
    a = { ":lua attach_to_debug()<CR>", "Attach to dap" },
    r = { ":lua run_spring_boot(true)<CR>", "Run in debug mode" },
  },
}
